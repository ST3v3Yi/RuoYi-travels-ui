...
export const constantRoutes = [
  ...
  },
  {
    path: '/about',
    name: 'About',
    component: () => import('../views/travels/About.vue')
  },
  {
    path: '/personal',
    name: 'Personal',
    component: () => import('../views/travels/Personal.vue')
  },
  {
    path: '/site',
    name: 'Site',
    component: () => import('../views/travels/Site.vue')
  },
  {
    path: '/hotel',
    name: 'Hotel',
    component: () => import('../views/travels/Hotel.vue')
  },
  {
    path: '/announcement',
    name: 'Announcement',
